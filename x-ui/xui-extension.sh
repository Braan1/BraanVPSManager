...
BASE_URL="https://raw.githubusercontent.com/braan1/BraanVPSManager/master/x-ui"
...
mkdir -p /etc/BraanVPSManager >/dev/null 2>&1
touch /etc/BraanVPSManager/xray_paths.txt >/dev/null 2>&1
